...
import { lastValueFrom, firstValueFrom, Subscription } from 'rxjs';
import { UserService } from '../../services/user.service';
declare var $: any;

@Component({
  selector: 'app-business-ad-manager',
  templateUrl: './business-ad-manager.component.html',
  styleUrl: './business-ad-manager.component.scss'
})
export class BusinessAdManagerComponent implements OnInit {
  ...
  loadAccount(){
    this.tablesService.GetFiltered('advertisement_accounts','venue_id', this.user.venue_id).subscribe((data:any) => {
      this.itemx = data[0];
      this.advertisement_account_id = this.itemx.advertisement_account_id;
